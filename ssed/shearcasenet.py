...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=20):
        ...
        self.res5 = self._make_layer(block, 512, layers[3], stride=1, special_case=True) # Notice official resnet is 2, but shearCASENet here is 1.
...
if __name__ == "__main__":
    model = shearCASENet_resnet101(pretrained=False, num_classes=20)

    npy_folder = "./shearCASENet_trained_model.npz"
    loaded_model_path = "./trained_shearCASENet.pth.tar"
